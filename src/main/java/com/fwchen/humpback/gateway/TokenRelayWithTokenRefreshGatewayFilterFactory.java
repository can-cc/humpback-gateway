...
/**
 * Token Relay Gateway Filter with Token Refresh. This can be removed when issue {@see
 * https://github.com/spring-cloud/spring-cloud-security/issues/175} is closed. Implementierung in
 * Anlehnung an {@link ServerOAuth2AuthorizedClientExchangeFilterFunction}
 */
@Component
public class TokenRelayWithTokenRefreshGatewayFilterFactory
  ...
  public TokenRelayWithTokenRefreshGatewayFilterFactory(
    ...
    this.authorizedClientManager =
        createDefaultAuthorizedClientManager(
  ...
  private Mono<OAuth2AuthorizedClient> authorizeClient(
